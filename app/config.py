...
HISTORY_LOOKBACK_MINUTES = int(os.getenv("HISTORY_LOOKBACK_MINUTES", "150"))
PREDICTION_SHORT_HISTORY_MINUTES = int(os.getenv("PREDICTION_SHORT_HISTORY_MINUTES", "15"))
PREDICTION_LONG_HISTORY_MINUTES = int(os.getenv("PREDICTION_LONG_HISTORY_MINUTES", "180"))

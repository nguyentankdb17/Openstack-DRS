...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BuildFeatures = channel.unary_unary(
                ...
                response_deserializer=analytics__pb2.BuildFeaturesResponse.FromString,
                _registered_method=True)
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BuildFeatures': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analytics__pb2.BuildFeaturesRequest.FromString,
                    response_serializer=analytics__pb2.BuildFeaturesResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'drs.analytics.AnalyticsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('drs.analytics.AnalyticsService', rpc_method_handlers)
...
class AnalyticsService(object):
    ...
    def BuildFeatures(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/drs.analytics.AnalyticsService/BuildFeatures',
            analytics__pb2.BuildFeaturesRequest.SerializeToString,
            analytics__pb2.BuildFeaturesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
